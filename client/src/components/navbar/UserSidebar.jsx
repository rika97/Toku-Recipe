        ...
        >
            ...
            <List>
                <ListItem disablePadding onClick={() => {navigate("/coupons");}}>
                    <ListItemButton>
                    <ListItemIcon>
                        <LocalOfferIcon style={{ color: '#424242' }} />
                    </ListItemIcon>
                    <ListItemText primary="Deals" />
                    </ListItemButton>
                </ListItem>

                <ListItem disablePadding onClick={() => {navigate("/recipebook");}}>
                    <ListItemButton>
                    <ListItemIcon>
                        <FastfoodIcon style={{ color: '#424242' }} />
                    </ListItemIcon>
                ...
                <ListItem disablePadding onClick={() => {
                    ...
                    <ListItemButton>
                    <ListItemIcon>
                        <Inventory2Icon style={{ color: '#424242' }} />
                    </ListItemIcon>
                ...
                <ListItem disablePadding onClick={() => {
                    ...
                    <ListItemButton>
                    <ListItemIcon>
                        <ListAltIcon style={{ color: '#424242' }} />
                    </ListItemIcon>
